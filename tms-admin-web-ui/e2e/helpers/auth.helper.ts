...
export const TEST_USERS = {
  admin: {
    ...
    roles: ['ADMIN', 'SUPERADMIN'] as readonly string[],
  },
  dispatcher: {
    username: 'dispatcher',
    password: 'dispatcher123',
    email: 'dispatcher@svlogistics.com',
    roles: ['DISPATCHER'] as readonly string[],
  },
  driver: {
    username: 'driver',
    password: 'driver123',
    email: 'driver@svlogistics.com',
    roles: ['DRIVER'] as readonly string[],
  },
} as const;
...
export interface AuthResult {
  token: string;
  permissions: string[];
  user: TestUser | Record<string, unknown>;
}

export async function loginViaAPI(page: Page, user: TestUser): Promise<AuthResult> {
