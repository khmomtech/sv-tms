...
// tests for DriverCreateRequest
void main() {
  // final instance = DriverCreateRequest();

  group('test DriverCreateRequest', () {
    ...
    test('to test the property `partnerCompany`', () async {
      // TODO
    });
    ...
    test('to test the property `assignedVehicleId`', () async {
      // TODO
    });
