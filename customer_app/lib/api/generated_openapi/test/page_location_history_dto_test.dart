...
// tests for PageLocationHistoryDto
void main() {
  // final instance = PageLocationHistoryDto();

  group('test PageLocationHistoryDto', () {
    // int totalElements
    ...
    // List<LocationHistoryDto> content (default value: const [])
