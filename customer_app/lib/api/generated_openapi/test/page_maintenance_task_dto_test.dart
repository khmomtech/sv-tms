...
// tests for PageMaintenanceTaskDto
void main() {
  // final instance = PageMaintenanceTaskDto();

  group('test PageMaintenanceTaskDto', () {
    // int totalElements
    ...
    // List<MaintenanceTaskDto> content (default value: const [])
