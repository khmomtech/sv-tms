...
// tests for PageMaintenanceTaskTypeDto
void main() {
  // final instance = PageMaintenanceTaskTypeDto();

  group('test PageMaintenanceTaskTypeDto', () {
    // int totalElements
    ...
    // List<MaintenanceTaskTypeDto> content (default value: const [])
