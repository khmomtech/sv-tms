...
// tests for PageResponseAttendanceDto
void main() {
  // final instance = PageResponseAttendanceDto();

  group('test PageResponseAttendanceDto', () {
    // List<AttendanceDto> content (default value: const [])
