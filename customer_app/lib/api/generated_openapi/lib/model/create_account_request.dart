...
class CreateAccountRequest {
  ...
  @override
  String toString() => 'CreateAccountRequest[username=$username, password=$password, email=$email]';
  ...
  static Map<String, List<CreateAccountRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = CreateAccountRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
