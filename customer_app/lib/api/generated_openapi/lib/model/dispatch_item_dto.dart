...
class DispatchItemDto {
  /// Returns a new [DispatchItemDto] instance.
  DispatchItemDto({
    this.id,
    this.itemName,
    this.quantity,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DispatchItemDto &&
    other.id == id &&
  ...
  @override
  String toString() => 'DispatchItemDto[id=$id, itemName=$itemName, quantity=$quantity, unitOfMeasurement=$unitOfMeasurement, palletType=$palletType, dimensions=$dimensions, weight=$weight, palletQty=$palletQty, loadingPlace=$loadingPlace]';
  ...
  /// Returns a new [DispatchItemDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DispatchItemDto? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<DispatchItemDto> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <DispatchItemDto>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DispatchItemDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DispatchItemDto> mapFromJson(dynamic json) {
    final map = <String, DispatchItemDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DispatchItemDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of DispatchItemDto-objects as value to a dart map
  static Map<String, List<DispatchItemDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<DispatchItemDto>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = DispatchItemDto.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
