...
class PageCustomer {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PageCustomer &&
  ...
  @override
  String toString() => 'PageCustomer[totalElements=$totalElements, totalPages=$totalPages, pageable=$pageable, numberOfElements=$numberOfElements, first=$first, last=$last, size=$size, content=$content, number=$number, sort=$sort, empty=$empty]';
  ...
  static PageCustomer? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PageCustomer(
        ...
        content: Customer.listFromJson(json[r'content']),
  ...
  static List<PageCustomer> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<PageCustomer>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PageCustomer>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PageCustomer.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
