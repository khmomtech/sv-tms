...
class ApiResponseListMapStringObject {
  ...
  @override
  String toString() => 'ApiResponseListMapStringObject[success=$success, message=$message, code=$code, data=$data, errors=$errors, timestamp=$timestamp, requestId=$requestId]';
