...
class ApiResponseListLong {
  ...
  @override
  String toString() => 'ApiResponseListLong[success=$success, message=$message, code=$code, data=$data, errors=$errors, timestamp=$timestamp, requestId=$requestId]';
