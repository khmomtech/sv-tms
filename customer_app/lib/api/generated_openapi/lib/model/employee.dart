...
class Employee {
  ...
  @override
  String toString() => 'Employee[id=$id, employeeCode=$employeeCode, firstName=$firstName, lastName=$lastName, email=$email, phoneNumber=$phoneNumber, department=$department, position=$position, hireDate=$hireDate, status=$status, user=$user]';
