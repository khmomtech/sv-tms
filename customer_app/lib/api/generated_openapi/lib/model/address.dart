...
class Address {
  ...
  @override
  String toString() => 'Address[id=$id, name=$name, address=$address, postcode=$postcode, city=$city, country=$country, phone=$phone, latitude=$latitude, longitude=$longitude, customer=$customer]';
