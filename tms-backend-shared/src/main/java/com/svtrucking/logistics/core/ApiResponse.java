...
public class ApiResponse<T> {
  ...
  public ApiResponse(
      boolean success, String message, String code, T data, Object errors, Instant timestamp) {
  ...
  public static <T> ApiResponse<T> success(String message) {
    return new ApiResponse<>(
        true, message, null, null, null, Instant.now(), UUID.randomUUID().toString());
  }

  public static <T> ApiResponse<T> ok(String message, T data) {
    return new ApiResponse<>(
        true, message, null, data, null, Instant.now(), UUID.randomUUID().toString());
  }

  public static <T> ApiResponse<T> fail(String message) {
    return new ApiResponse<>(
        false, message, null, null, null, Instant.now(), UUID.randomUUID().toString());
  }

  public static <T> ApiResponse<T> fail(String message, Object errors) {
    return new ApiResponse<>(
        false, message, null, null, errors, Instant.now(), UUID.randomUUID().toString());
  }

  public static <T> ApiResponse<T> failWithCode(String message, String code) {
    return new ApiResponse<>(
        false, message, code, null, null, Instant.now(), UUID.randomUUID().toString());
  }
