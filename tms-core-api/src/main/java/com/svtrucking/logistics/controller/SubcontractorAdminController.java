...
/**
 * Alias controller for subcontractor admins (synonym of vendor admins).
 * Exposes /api/subcontractor-admins while delegating to PartnerAdminService.
 */
@RestController
@RequestMapping("/api/subcontractor-admins")
@RequiredArgsConstructor
public class SubcontractorAdminController {
  ...
  public ResponseEntity<ApiResponse<List<PartnerAdmin>>> getAdminsByCompany(
    ...
    return ResponseEntity.ok(new ApiResponse<>(true, "Subcontractor admins retrieved successfully", admins));
  }
  ...
  public ResponseEntity<ApiResponse<List<PartnerAdmin>>> getCompaniesByUser(
    ...
    return ResponseEntity.ok(new ApiResponse<>(true, "Subcontractor companies retrieved successfully", companies));
  }
  ...
  public ResponseEntity<ApiResponse<PartnerAdmin>> assignAdmin(
    ...
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(new ApiResponse<>(true, "Admin assigned to subcontractor company successfully", admin));
  }
