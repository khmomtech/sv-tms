-- Align pre-entry master to requested 3-category Khmer structure.

-- 1) Upsert the 3 requested categories (keep workflow-safe codes)
...
-- 2) Upsert exact item list and assign to requested categories
...
-- 3) Deactivate anything outside requested structure
