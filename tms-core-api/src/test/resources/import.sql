...
-- Employees
INSERT INTO employees (id, employee_code, first_name, last_name, email, user_id) VALUES (1, 'EMP001', 'Super', 'Admin', 'superadmin@example.com', 1);
INSERT INTO employees (id, employee_code, first_name, last_name, email, user_id) VALUES (2, 'EMP002', 'Admin', 'User', 'admin@example.com', 2);
